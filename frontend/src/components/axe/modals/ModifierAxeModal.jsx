...
const ModifierAxeModal = ({ show, onClose, onAxeUpdated, axe }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        setLoading(true);
        try {
            const response = await api.put(`axes/${axe.id}/`, formData);
            onAxeUpdated(response.data);
            setErrors({});
        } catch (error) {
            ...
            if (error.response?.data) {
                ...
                toast.error('Erreur lors de la modification de l\'axe');
            }
        } finally {
            setLoading(false);
        }
...
export default ModifierAxeModal;